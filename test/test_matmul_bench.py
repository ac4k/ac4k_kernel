import torch
# from ac4k_kernel.ops import scaled_nvfp4_quant, cutlass_scaled_nvfp4_mm, ac4k_scaled_nvfp4_mm
...
def test_nvfp4_gemm(
    ...
    print(
        f"expected_out : {expected_out}, {expected_out.shape}, {expected_out.dtype}"
    )
