...
def test_attention_bench(B, N, H, D, layout, precision="nvfp4"):
    ...
    def get_ac4k(q, k, v, layout, precision="nvfp4"):
    ...
    o = get_ac4k(q, k, v, layout, precision=precision)
    print("o ac4k:")
    print(o[0, :4, 0, :8])
...
if __name__ == "__main__":
    ...
    test_attention_bench(1, 75600, 1, 128, "BNHD", precision="int8+fp8e4m3")
    test_attention_bench(1, 100, 1, 128, "BNHD", precision="int8+fp8e4m3")
    test_attention_bench(10, 330, 12, 100, "BNHD", precision="int8+fp8e4m3")
    test_attention_bench(1, 256, 1, 128, "BNHD", precision="int8+fp8e4m3")
    test_attention_bench(1, 128, 1, 128, "BNHD", precision="int8+fp8e4m3")
    test_attention_bench(2, 128, 3, 128, "BNHD", precision="int8+fp8e4m3")
    test_attention_bench(1, 33, 1, 128, "BNHD", precision="int8+fp8e4m3")
    test_attention_bench(1, 444, 1, 88, "BNHD", precision="int8+fp8e4m3")
    test_attention_bench(2, 111, 2, 100, "BHND", precision="int8+fp8e4m3")
