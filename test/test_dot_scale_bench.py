...
if __name__ == "__main__":
    ...
    random.seed(9567)
    test_dot_scale(torch.bfloat16, (128, 128, 128))
    test_dot_scale(torch.bfloat16, (10, 512, 512))
    test_dot_scale(torch.bfloat16, (1024, 1024, 384))
    test_dot_scale(torch.bfloat16, (130, 384, 256))
    test_dot_scale(torch.bfloat16, (666, 768, 512))
    test_dot_scale(torch.bfloat16, (123, 321, 256))
    test_dot_scale(torch.bfloat16, (10, 15, 512))
    test_dot_scale(torch.bfloat16, (8192, 8192, 8192))
